...
| Step 3 | 2026-07-14に保留解除。Music Understanding adapter、AI非依存の固定EQ core／AU／snapshot handoff、iOS 27 Debug試聴UI、版付きoffline FeatureSnapshot／cache境界を実装。Core AI、曲別候補、cacheのruntime呼び出し、production DSP再生は未接続 |

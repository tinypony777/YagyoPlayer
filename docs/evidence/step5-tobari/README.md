...
- iPhone 17 Pro / iOS 26.5の全回帰は **139 / 139 PASS、failure 0、skip 0**。解析、再生、取込、行列、巻物、3タブと全実描画artifactを含む。xcresultは外付けSSDの`/Volumes/MacBook_Data_Add/CodexDerivedData/YagyoPlayer/dsp-phase-b-final-full-20260713/full.xcresult`。

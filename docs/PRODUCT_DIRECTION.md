...
- **現在地(正直に)**: **Phase A(一画面検聴)は完了し`main`へ統合済み**(PR #16、ユーザー本人が実機確認のうえ承認・2026-07-12)。ITU-R BS.1770-4のIntegrated/Max Short-term、Sample Peak、True Peak(4x)、クリップ疑いラン、モノ互換相関を、[Mastering-App](https://github.com/tinypony777/Mastering-App)のDSPコアを補修して移植。full suite 100/100、EBU基準系・44.1kHz適合をテストで固定([証跡](evidence/step5-tobari/README.md))。A/B参照(Phase B)、チェックポイント(C)、共有シート取込(D)は未実装。
